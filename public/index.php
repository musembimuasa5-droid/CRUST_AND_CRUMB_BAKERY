...
<body>
  ...
  <header class="site-header" data-header>
    ...
    <nav id="main-nav" class="main-nav" aria-label="Main navigation">
      <a href="#shop">Shop</a><a href="#fresh">Fresh today</a><a href="#celebrate">Celebrations</a><a href="#story">Our story</a>
      <div class="nav-actions"><button class="icon-button" type="button" data-account aria-label="Open account">Account</button><button class="cart-button" type="button" data-cart aria-label="Open cart">Cart <span data-cart-count>0</span></button></div>
    </nav>
  </header>

  <main>
    <section class="hero page-width">
      <div class="hero-copy reveal"><p class="eyebrow">Nairobi's neighbourhood bakehouse</p><h1>Good days start<br><i>with good bread.</i></h1><p class="hero-lede">Hand-shaped sourdough, golden pastries, and cakes made for the moments worth gathering around.</p><div class="hero-actions"><a class="button button-dark" href="#shop">Shop the bakehouse <span>↗</span></a><a class="text-link" href="#celebrate">Plan a celebration <span>→</span></a></div><div class="trust-row"><span><strong>4.9/5</strong> from 300+ neighbours</span><span class="trust-stars">★★★★★</span></div></div>
  ...
  <footer class="site-footer"><div class="page-width footer-grid"><div><a class="brand footer-brand" href="./"><span class="brand-mark">C<span>&</span>C</span><span>Crust <em>&</em> Crumb</span></a><p>Small-batch baking for everyday rituals<br>and very special occasions.</p></div><div><p class="footer-label">Visit</p><p>14 Riverside Lane<br>Nairobi, Kenya</p></div><div><p class="footer-label">Say hello</p><p><a href="mailto:hello@crustcrumb.test">hello@crustcrumb.test</a><br><a href="tel:+254700000000">+254 700 000 000</a></p></div><div><p class="footer-label">Follow along</p><p><a href="#">Instagram</a><br><a href="#">TikTok</a></p></div></div><div class="page-width footer-bottom"><span>© <?= date('Y') ?> Crust & Crumb Bakery</span><span>Freshly baked in Nairobi</span></div></footer>
